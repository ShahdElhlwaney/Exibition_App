...
class TextFieldWithSuffix extends StatelessWidget {
  const TextFieldWithSuffix({Key? key, required this.onChanged, required this.icon, required this.obscureText, required this.onTap, required this.validator}) : super(key: key);
